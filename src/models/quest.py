...
if TYPE_CHECKING:
    ...
    # from .quest_step import QuestStep # For GeneratedQuest relationship to current_step
...
class GeneratedQuest(Base):
    ...
    # player_progress: Mapped[List["PlayerQuestProgress"]] = relationship(back_populates="quest")
    __table_args__ = (
