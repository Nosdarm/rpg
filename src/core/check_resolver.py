...
class CheckOutcome(BaseModel):
    # Using strings for outcome status for flexibility, could be an Enum later
...
class CheckResult(BaseModel):
    ...
    raw_rolls: List[int] = Field(..., description="List of individual dice results before any modifiers or interpretation (e.g., for advantage/disadvantage)")
    ...
    # For logging or additional context
