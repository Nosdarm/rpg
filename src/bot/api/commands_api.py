...
from src.models.command_info import CommandListResponse, CommandInfo # CommandInfo for type hint
# from src.core.localization_utils import get_guild_language_or_default # Potential
# from src.core.database import get_session, AsyncSession # Potential
...
async def list_bot_commands(
    ...
    # from src.core.localization_utils import get_guild_language_or_default
    ...
    if not final_lang_to_use:
        ...
        # Или можно использовать константу из src.config.settings
        from src.config.settings import BOT_LANGUAGE as DEFAULT_BOT_LANGUAGE
