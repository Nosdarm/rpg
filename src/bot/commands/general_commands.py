...
class GeneralCog(commands.Cog, name="General Commands"):
    ...
    @transactional
    async def start_command(self, interaction: discord.Interaction, *, session: AsyncSession):
        """Начинает игру для нового игрока или показывает информацию о существующем."""
