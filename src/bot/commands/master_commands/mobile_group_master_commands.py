...
class MasterMobileGroupCog(commands.Cog, name="Master Mobile Group Commands"):
    ...
    async def mobile_group_view(self, interaction: discord.Interaction, group_id: int):
        ...
        async with get_db_session() as session:
            ...
            members = await global_npc_crud.get_multi_by_guild_and_attribute(session, guild_id=interaction.guild_id, attribute_name="mobile_group_id", attribute_value=group_id, limit=25)
