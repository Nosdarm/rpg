...
# CRUDs to be mocked
# Assuming paths like 'src.core.crud.global_npc_crud'
# from src.core.crud import global_npc_crud, mobile_group_crud, player_crud # etc.

# Core systems to be mocked
# from src.core.rules import get_rule
# from src.core.check_resolver import resolve_check, CheckError
# from src.core.combat_cycle_manager import start_combat
# from src.core.quest_system import handle_player_event_for_quest
# from src.core.game_events import log_event
# from src.core.relationship_system import get_relationship_between_entities

# Function to test
# from src.core import global_entity_manager # This was causing issues with __init__.py
import src.core.global_entity_manager # Import the module path directly
# from src.core.global_entity_manager import simulate_global_entities_for_guild # Will be called via the module path
...
class TestGlobalEntityManager(unittest.IsolatedAsyncioTestCase):
    ...
    async def asyncSetUp(self):
        ...
        # using patch.object
        self.patchers = [
            patch.object(src.core.global_entity_manager, "global_npc_crud"),
            patch.object(src.core.global_entity_manager, "mobile_group_crud"),
            patch.object(src.core.global_entity_manager, "player_crud"),
            patch.object(src.core.global_entity_manager, "generated_npc_crud"),
            patch.object(src.core.global_entity_manager, "location_crud"),
            patch.object(src.core.global_entity_manager, "crud_relationship"),
            patch.object(src.core.global_entity_manager, "get_rule"),
            patch.object(src.core.global_entity_manager, "resolve_check"),
            patch.object(src.core.global_entity_manager, "start_combat"),
            patch.object(src.core.global_entity_manager, "handle_player_event_for_quest"),
            patch.object(src.core.global_entity_manager, "log_event"),
            patch.object(src.core.global_entity_manager, "_simulate_entity_movement"),
            patch.object(src.core.global_entity_manager, "_simulate_entity_interactions"),
        ]
    ...
    async def test_simulate_mobile_group_triggers_combat(self):
        ...
        from src.core.global_entity_manager import simulate_global_entities_for_guild
