...
from backend.models import PendingGeneration, Player
from backend.models.enums import ModerationStatus, PlayerStatus
# Corrected import path for generic CRUD functions
from backend.core.crud_base_definitions import get_entity_by_id, update_entity
from backend.core.ai_orchestrator import save_approved_generation
# Corrected import for CustomValidationError
from backend.core.ai_response_parser import parse_and_validate_ai_response, CustomValidationError, ParsedAiData
# from backend.config.settings import MASTER_ROLE_NAME # Assuming a setting for Master role name
...
# Example: BOT_COGS = [..., "backend.bot.commands.master_ai_commands"]
