...
from backend.core.world_generation import generate_location # Исправлено
from backend.config import settings # Для проверки ID Мастера/Админа
...
# В src/bot/core.py нужно будет добавить 'backend.bot.commands.map_commands' в список когов для загрузки.
