...
from backend.core.player_utils import get_player_by_discord_id
from backend.core.party_utils import get_party # Renamed from get_party_by_id as it doesn't exist
...
# from backend.core.turn_controller import process_guild_turn_if_ready (or similar name)
...
class TurnManagementCog(commands.Cog):
    ...
    async def end_turn_command(self, interaction: discord.Interaction):
        ...
        async with session_maker() as session:
            ...
            # This will be implemented in backend.core.turn_controller
            try:
                from backend.core.turn_controller import trigger_guild_turn_processing
