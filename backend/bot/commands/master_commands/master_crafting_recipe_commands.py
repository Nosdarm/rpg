...
from backend.core.crud.crud_crafting_recipe import crud_crafting_recipe
from backend.core.crud.crud_item import item_crud # For validating result_item_id and ingredient item_ids
from backend.core.crud.crud_skill import skill_crud # For validating required_skill_id (assuming skill_crud exists)
...
# from backend.models.crafting_recipe import CraftingRecipe # For type hinting if needed directly
...
try:
    from backend.core.crud.crud_skill import skill_crud
except ImportError:
