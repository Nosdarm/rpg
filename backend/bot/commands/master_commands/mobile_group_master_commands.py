...
from backend.core.crud.crud_location import location_crud # For validation
from backend.core.crud.crud_global_npc import global_npc_crud # For dependency check & validation
