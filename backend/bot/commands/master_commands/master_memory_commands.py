...
from backend.core.crud.crud_player_npc_memory import crud_player_npc_memory
from backend.core.crud.crud_player import player_crud # For fetching names and validation
from backend.core.crud.crud_npc import npc_crud # For fetching names and validation
from backend.core.database import get_db_session
from backend.core.crud_base_definitions import update_entity # For update command
...
from backend.models.player_npc_memory import PlayerNpcMemory # For type hinting
