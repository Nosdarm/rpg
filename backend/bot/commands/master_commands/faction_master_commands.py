...
from backend.core.crud.crud_npc import npc_crud # For dependency validation
...
class MasterFactionCog(commands.Cog, name="Master Faction Commands"): # type: ignore[call-arg]
