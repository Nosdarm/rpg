...
from backend.core.crud.crud_faction import crud_faction # To validate faction_id
...
class MasterNpcCog(commands.Cog, name="Master NPC Commands"): # type: ignore[call-arg]
