...
from backend.models.quest import QuestStep as QStepModel, PlayerQuestProgress as PQPModel
from backend.bot.utils import parse_json_parameter
from backend.models.enums import QuestStatus # For progress_update
...
class MasterQuestCog(commands.Cog, name="Master Quest Commands"): # type: ignore[call-arg]
    ...
    async def progress_create(self, interaction: discord.Interaction,
        ...
        async with get_db_session() as session:
            ...
            if player_id:
                from backend.core.crud.crud_player import player_crud # Local import to avoid circular dependency at module level
            ...
            if party_id:
                from backend.core.crud.crud_party import party_crud # Local import
