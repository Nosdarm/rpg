...
from backend.models.story_log import StoryLog # Import model
from backend.core.crud_base_definitions import CRUDBase # Use base CRUD for simple models
from backend.core.database import get_db_session
from backend.core.localization_utils import get_localized_message_template
from backend.models.enums import EventType as EventTypeEnum # For validation
