...
from backend.core.crud.crud_pending_generation import pending_generation_crud
from backend.core.crud_base_definitions import update_entity # For direct updates if needed
from backend.core.localization_utils import get_localized_master_message
from backend.models import PendingGeneration
from backend.models.enums import ModerationStatus
from backend.core.ai_orchestrator import trigger_ai_generation_flow, save_approved_generation
from backend.bot.utils import parse_json_parameter, ensure_guild_configured_and_get_session
