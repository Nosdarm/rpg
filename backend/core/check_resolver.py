...
from backend.models.check_results import CheckResult, ModifierDetail, CheckOutcome
...
async def resolve_check(
    ...
    return CheckResult(
        ...
        dc=difficulty_dc, # Use the alias 'dc' for Pydantic model field 'difficulty_class'
