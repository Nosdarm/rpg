...
from backend.models import Player, GeneratedNpc, PendingConflict, GuildConfig
...
from backend.core.crud import player_crud, npc_crud, pending_conflict_crud
from backend.core import action_processor
...
from backend.core.rules import get_rule # Убедиться, что импорт есть
