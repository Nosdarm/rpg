...
from backend.core.ai_response_parser import parse_and_validate_ai_response, BaseGeneratedEntity, CustomValidationError, ParsedAiData
from backend.core.rules import get_rule
from backend.core.ai_orchestrator import make_real_ai_call
    ...
    for i in range(target_count):
        ...
        try:
            ...
            if report.parsed_entity_data:
                ...
                from backend.core.crud import guild_crud as guild_config_crud
