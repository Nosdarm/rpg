...
class CraftingRecipe(Base):
    ...
    description_i18n: Mapped[Optional[Dict[str, str]]] = mapped_column(JSON, nullable=True, default=lambda: {})
    ...
    ingredients_json: Mapped[List[Dict[str, Any]]] = mapped_column(JSON, nullable=False, default=lambda: [])
