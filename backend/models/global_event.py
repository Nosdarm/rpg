...
class GlobalEvent(Base, TimestampMixin):
    ...
    name_i18n: Mapped[Dict[str, str]] = mapped_column(JsonBForSQLite, nullable=False)
    description_i18n: Mapped[Dict[str, str]] = mapped_column(JsonBForSQLite, nullable=False) # Was Optional, made it required as per design
    ...
    properties_json: Mapped[Dict[str, Any]] = mapped_column(JsonBForSQLite, default=lambda: {}, nullable=False)
