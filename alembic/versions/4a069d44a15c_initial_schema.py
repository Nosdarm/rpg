...
def upgrade() -> None:
    ...
    sa.Column('current_status', sa.Enum('UNKNOWN', 'IDLE', 'EXPLORING', 'COMBAT', 'DIALOGUE', 'TRADING', 'MENU', 'AWAY', 'DEAD', 'AWAITING_MODERATION', 'TURN_ENDED_PENDING_RESOLUTION', 'PROCESSING_GUILD_TURN', name='player_status_enum', create_constraint=True), nullable=False),
